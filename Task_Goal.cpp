...
namespace  Goal
{
	...
	{
		this->img = DG::Image::Create("./data/image/goal.png");
		return true;
	}
	//-------------------------------------------------------------------
	//リソースの解放
	...
	BChara::DrawInfo Object::Anim()
	{
		BChara::DrawInfo imageTable[] = {
			//draw                     //src
			{ ML::Box2D(-15,-15,30,30),ML::Box2D(0,0,60,60),ML::Color(1,1,1,1) },
		/*{ ML::Box2D(-15,-15,30,30),ML::Box2D(0,0,60,60),ML::Color(0.3f,1,1,1) },*/
